package com.yg0r2.kinesis.client.example.bes.kinesis.record.domain;
...
@JsonDeserialize(builder = KinesisMessageRecord.Builder.class)
@JsonInclude(JsonInclude.Include.NON_EMPTY)
public final class KinesisMessageRecord implements MessageRecord {
    ...
    private KinesisMessageRecord(Builder builder) {
    ...
    public static Builder builder(KinesisMessageRecord kinesisRecord) {
    ...
    public static class Builder {
        ...
        private Builder(KinesisMessageRecord kinesisMessageRecord) {
            bookingEmailRequest = kinesisMessageRecord.getBookingEmailRequest();
            createDateTime = kinesisMessageRecord.createDateTime;
            nextRetryDateTime = kinesisMessageRecord.nextRetryDateTime;
            retryCount = kinesisMessageRecord.getRetryCount();
        }
        ...
        public KinesisMessageRecord build() {
            return new KinesisMessageRecord(this);
        }
