package com.yg0r2.kinesis.client.example.bes.kafka.record.domain;
...
public final class KafkaMessageRecord implements MessageRecord {
    ...
    public static Builder builder(KafkaMessageRecord kinesisRecord) {
    ...
    public static class Builder {
        ...
        private Builder(KafkaMessageRecord kinesisMessageRecord) {
