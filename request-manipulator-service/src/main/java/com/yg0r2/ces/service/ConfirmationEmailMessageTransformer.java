...
class ConfirmationEmailMessageTransformer {
    ...
    public ConfirmationEmailMessage transform(ConfirmationEmailRequest confirmationEmailRequest) {
        ...
        confirmationEmailMessage.setCreateRequest(createRequestTransformer.transform(confirmationEmailRequest));
